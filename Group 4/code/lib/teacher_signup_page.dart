...
class _TeacherSignupPageState extends State<TeacherSignupPage> {
  ...
  Future<void> signUp() async {
    ...
    if (branchController.text.trim().isEmpty) {
      _showSnackBar("Please enter your branch/department", Colors.red);
      return;
    }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 15),
                  _buildTextField("Room Number", Icons.meeting_room, roomNoController),
                  const SizedBox(height: 15),
                  _buildTextField("Branch/Department *", Icons.business, branchController),
                  const SizedBox(height: 15),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => Navigator.pushReplacementNamed(context, '/login', arguments: 'teacher'),
